...
const Skiper = () => {
  ...
  className=" bg-white border-none px-7 py-2 rounded-full active:scale-95 transition-all text-black pop font-semibold magnet mb-5 text-2xl big "
>
  <AnimatedButton text="View&asaa More Project" />
</button>
        </div>
      </div>
    </>
