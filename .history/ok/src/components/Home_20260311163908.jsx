...
<div className="mid0 w-full lg:h-[10%] "></div>
 ...
 <div className='  w-full py-2  lg:py-4 '><h1 className='text-4xl md:text-6xl lg:text-[120px] big font-semibold text-center text-[#6BD3C7] uppercase'>Web Solutions from</h1></div>
          </div>
          <div className="mid3 w-full h-[30%]  flex lg:items-end leading-4  text-center ">
 <div className=' w-full  '><h1 className='text-4xl md:text-6xl lg:text-[120px] big font-semibold text-center uppercase'>Frontend to Backend</h1>
 <br></br>
