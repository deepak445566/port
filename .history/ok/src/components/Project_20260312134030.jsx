...
const DesktopProjectPair = ({ i, pair, progress, range, targetScale }) => {
  ...
  return (
    <div className="sticky -top-[20vh] lg:-top-50 flex items-center justify-center">
      <motion.div
...
const Skiper = () => {
    ...
    <>
      <div id="work" className="bg-black rounded-3xl lg:rounded-[10vh]">
        ...
        WORK
          ...
          <p className="text-gray-400 mt-2 text-lg text-center lg:text-left"id="project">
  ...
  className=" bg-white border-none px-7 py-2 rounded-full active:scale-95 transition-all text-black pop font-semibold magnet mb-5 text-xl big  "
>
  <AnimatedButton text="View&nbsp; More &nbsp; Project" />
</button>
        </div>
      </div>
    </>
