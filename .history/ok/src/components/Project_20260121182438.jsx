...
const ProjectCard = ({ project, index }) => {
  return (
    <a 
      ...
      className="group relative overflow-hidden rounded-2xl h-full block" // rounded-xl और rounded-2xl conflict था
    >
...
const DesktopProjectPair = ({ i, pair, progress, range, targetScale }) => {
  ...
  return (
    <div className="sticky -top-[30vh] lg:-top-30 flex items-center justify-center">
      <motion.div
