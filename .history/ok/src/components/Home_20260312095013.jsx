...
<div className="mid0 w-full lg:h-[10%] "></div>
 ...
 <div className='  w-full py-2  lg:py-4 '><h1 className='text-4xl md:text-6xl lg:text-[100px] xl:text big font-semibold text-center text-[#6BD3C7] uppercase'>Web Solutions from</h1></div>
          </div>
