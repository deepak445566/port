    ...
    <section  className="flex flex-col md:flex-row items-center justify-center gap-10 lg:gap-30 max-md:px-4 mt-15 lg:mt-20 mont" id='about'>
                ...
                <div className="relative   rounded-2xl overflow-hidden shrink-0 -mt-5 lg:mt-0">
                    ...
                    <img className=" w-80 object-cover h-80 lg:h-100 rounded-2xl "
                        src="https://images.unsplash.com/photo-1613909207039-6b173b755cc1?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTJ8fGFnZW5jeXxlbnwwfHwwfHx8MA%3D%3D&auto=format&fit=crop&q=60&w=600"
                        alt="" />
                ...
                <div className="text-sm text-slate-600 max-w-xl ">
                    <h1 className=" relative group  text-4xl  uppercase font-semibold  big hidden lg:block text-slate-700">ABOUT US
                        <span className="absolute left-0 -bottom-1 h-0.5 w-0 bg-[#63D0C4] transition-all group-hover:w-40"></span>
                    </h1>
                    
                    <p ref={textRef} className="mt-5 alan text-xl  ">Hey 👋 I’m Deepak Pandey, a passionate Full Stack Developer who loves crafting modern, scalable, and visually engaging web applications. With expertise in the MERN stack, I focus on creating seamless user experiences, clean code, and innovative digital solutions. My goal is to turn creative ideas into powerful web products that make an impact. 🚀</p>
