...
const Skiper = () => {
  ...
  className="md:inline hidden bg-[#212121] border-none px-7 py-2 rounded-full active:scale-95 transition-all text-white pop font-semibold magnet text-center"
>
